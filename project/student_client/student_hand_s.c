...
extern const MIDL_SERVER_INFO StudentHand_ServerInfo;

extern const RPC_DISPATCH_TABLE StudentHand_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE StudentHand___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x4556509F,0x618A,0x46CF,{0xAB,0x3D,0xED,0x73,0x6E,0xD6,0x64,0x76}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&StudentHand_v1_0_DispatchTable,
    0,
    0,
    0,
    &StudentHand_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE StudentHand_v1_0_s_ifspec = (RPC_IF_HANDLE)& StudentHand___RpcServerInterface;
...
static const MIDL_STUB_DESC StudentHand_StubDesc = 
    {
    (void *)& StudentHand___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION StudentHand_table[] =
    {
    NdrAsyncServerCall,
    NdrAsyncServerCall,
    0
    };
static const RPC_DISPATCH_TABLE StudentHand_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)StudentHand_table
    };

static const SERVER_ROUTINE StudentHand_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Handup,
    (SERVER_ROUTINE)HandupEnd
    };

static const MIDL_SERVER_INFO StudentHand_ServerInfo = 
    {
    &StudentHand_StubDesc,
    StudentHand_ServerRoutineTable,
    student_hand__MIDL_ProcFormatString.Format,
    StudentHand_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
