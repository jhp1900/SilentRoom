...
! function(a, b) {
    ...
    var c = [],
        ...
        j = h.hasOwnProperty,
        k = {},
        l = "3.0.0-pre 3699ef463224a08233f9c37c6c7ad8235eb9a758+compat",
        m = function(a, b) {
    ...
    var x, y = a.document,
        ...
        A = m.fn.init = function(a, b, c) {
            ...
            if (c = c || x, "string" == typeof a) {
                if (d = "<" === a[0] && ">" === a[a.length - 1] && a.length >= 3 ? [null, a, null] : z.exec(a), !d || !d[1] && b) return !b || b.jquery ? (b || c).find(a) : this.constructor(b).find(a);
                if (d[1]) {
    ...
    m.Callbacks = function(a) {
        ...
        var b, c, d, e, f = [],
            ...
            j = {
                add: function() {
                    return f && (c && !b && (h = f.length - 1, g.push(c)), function d(b) { m.each(b, function(b, c) { m.isFunction(c) ? a.unique && j.has(c) || f.push(c) : c && c.length && "string" !== m.type(c) && d(c) }) }(arguments), c && !b && i()), this
                },
                remove: function() {
    ...
    m.extend({
        Deferred: function(a) {
                        ...
                        function g(a, b, c, e) {
                            return function() {
                                var h = this === d ? void 0 : this,
                                    ...
                                    k = e ? j : function() {
                                        try { j() } catch (d) { a + 1 >= f && (c !== H && (h = void 0, i = [d]), b.rejectWith(h || b.promise(), i)) }
                                    };
                                a ? k() : setTimeout(k)
                            }
                        }
                        return m.Deferred(function(d) { b[0][3].add(g(0, d, m.isFunction(e) ? e : G, d.notifyWith)), b[1][3].add(g(0, d, m.isFunction(a) ? a : G)), b[2][3].add(g(0, d, m.isFunction(c) ? c : H)) }).promise()
                    },
                    promise: function(a) {
            ...
            return m.each(b, function(a, f) {
                var g = f[2],
                    h = f[5];
                d[f[1]] = g.add, h && g.add(function() { c = h }, b[3 - a][2].disable, b[0][2].lock), g.add(f[3].fire), e[f[0]] = function() {
        ...
        when: function(a) {
            var b, c = 0,
                ...
                h = 1 === g ? a : m.Deferred(),
                i = function(a, b, c) {
                    return function(e) { b[a] = this, c[a] = arguments.length > 1 ? d.call(arguments) : e, c === j ? h.notifyWith(b, c) : --g || h.resolveWith(b, c) }
                },
                j, k, l;
            if (f > 1)
    ...
    function J() { y.addEventListener ? (y.removeEventListener("DOMContentLoaded", K), a.removeEventListener("load", K)) : (y.detachEvent("onreadystatechange", K), a.detachEvent("onload", K)) }
    ...
    function Q(a, b, d, e) {
        if (m.acceptData(a)) {
            ...
            if (k && j[k] && (e || j[k].data) || void 0 !== d || "string" != typeof b) {
                if (k || (k = i ? a[h] = c.pop() || m.guid++ : h), j[k] || (j[k] = i ? {} : { toJSON: m.noop }), f = j[k], e || (f.data || (f.data = {}), f = f.data), "object" == typeof b || "function" == typeof b) {
    ...
    var ea = { option: [1, "<select multiple='multiple'>", "</select>"], param: [1, "<object>", "</object>"], thead: [1, "<table>", "</table>"], col: [2, "<table><colgroup>", "</colgroup></table>"], tr: [2, "<table>", "</table>"], td: [3, "<table>", "</table>"], _default: k.htmlSerialize ? [0, "", ""] : [1, "X<div>", "</div>"] };
    ...
    m.event = {
        ...
        add: function(a, b, c, d, e) {
            ...
            if (r) {
                ...
                while (h--) f = na.exec(b[h]) || [], o = q = f[1], p = (f[2] || "").split(".").sort(), o && (j = m.event.special[o] || {}, o = (e ? j.delegateType : j.bindType) || o, j = m.event.special[o] || {}, l = m.extend({ type: o, origType: q, data: d, handler: c, guid: c.guid, selector: e, needsContext: e && m.expr.match.needsContext.test(e), namespace: p.join(".") }, i), (n = g[o]) || (n = g[o] = [], n.delegateCount = 0, j.setup && j.setup.call(a, d, p, k) !== !1 || (a.addEventListener ? a.addEventListener(o, k, !1) : a.attachEvent && a.attachEvent("on" + o, k))), j.add && (j.add.call(a, l), l.handler.guid || (l.handler.guid = c.guid)), e ? n.splice(n.delegateCount++, 0, l) : n.push(l), m.event.global[o] = !0);
                a = null
            }
        },
    ...
    }, m.removeEvent = y.removeEventListener ? function(a, b, c) { a.removeEventListener && a.removeEventListener(b, c) } : function(a, b, c) {
        var d = "on" + b;
        ...
        stopPropagation: function() {
            var a = this.originalEvent;
            this.isPropagationStopped = oa, a && (a.stopPropagation && a.stopPropagation(), a.cancelBubble = !0)
        },
        ...
        setup: function() {
            return m.nodeName(this, "form") ? !1 : void m.event.add(this, "click._submit keypress._submit", function(a) {
                ...
                c && !m._data(c, "submitBubbles") && (m.event.add(c, "submit._submit", function(a) { a._submitBubble = !0 }), m._data(c, "submitBubbles", !0))
            })
        },
        postDispatch: function(a) { a._submitBubble && (delete a._submitBubble, this.parentNode && !a.isTrigger && m.event.simulate("submit", this.parentNode, a, !0)) },
        teardown: function() {
            return m.nodeName(this, "form") ? !1 : void m.event.remove(this, "._submit")
        }
    }), k.changeBubbles || (m.event.special.change = {
        setup: function() {
            return ja.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (m.event.add(this, "propertychange._change", function(a) { "checked" === a.originalEvent.propertyName && (this._justChanged = !0) }), m.event.add(this, "click._change", function(a) { this._justChanged && !a.isTrigger && (this._justChanged = !1), m.event.simulate("change", this, a, !0) })), !1) : void m.event.add(this, "beforeactivate._change", function(a) {
                var b = a.target;
                ja.test(b.nodeName) && !m._data(b, "changeBubbles") && (m.event.add(b, "change._change", function(a) {!this.parentNode || a.isSimulated || a.isTrigger || m.event.simulate("change", this.parentNode, a, !0) }), m._data(b, "changeBubbles", !0))
            })
        },
        handle: function(a) {
            var b = a.target;
        ...
        on: function(a, b, c, d, e) {
            ...
            return null == c && null == d ? (d = b, c = b = void 0) : null == d && ("string" == typeof b ? (d = c, c = void 0) : (d = c, c = b, b = void 0)), d === !1 && (d = pa), 1 === e && (g = d, d = function(a) {
        ...
        off: function(a, b, c) {
            ...
            return (b === !1 || "function" == typeof b) && (c = b, b = void 0), c === !1 && (c = pa), this.each(function() { m.event.remove(this, a, c, b) })
        },
    ...
    var ra = / jQuery\d+="(?:null|\d+)"/g,
        sa = new RegExp("<(?:" + ca + ")[\\s/>]", "i"),
        ta = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,
        ua = /<(?:script|style|link)/i,
        va = /checked\s*(?:[^=]|=\s*.checked.)/i,
        wa = /^true\/(.*)/,
        xa = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
        ya = da(y),
        za = ya.appendChild(y.createElement("div"));
    ...
    function Ea(a, b) {
        ...
        if (1 === b.nodeType) {
            ...
            "script" === c && b.text !== a.text ? (Ba(b).text = a.text, Ca(b)) : "input" === c && $.test(a.type) ? b.checked = a.checked : "option" === c ? b.defaultSelected = b.selected = a.defaultSelected : ("input" === c || "textarea" === c) && (b.defaultValue = a.defaultValue)
        }
    }
    ...
    function Fa(a, b, c, d) {
        ...
        var f, g, h, i, j, l, n = 0,
            ...
            q = b[0],
            r = m.isFunction(q);
        if (r || o > 1 && "string" == typeof q && !k.checkClone && va.test(q)) return a.each(function(e) {
            var f = a.eq(e);
            r && (b[0] = q.call(this, e, f.html())), Fa(f, b, c, d)
        });
        if (o && (l = ia(b, a[0].ownerDocument, !1, a, d), f = l.firstChild, 1 === l.childNodes.length && (l = f), f || d)) {
            for (i = m.map(fa(l, "script"), Ba), h = i.length; o > n; n++) g = l, n !== p && (g = m.clone(g, !0, !0), h && m.merge(i, fa(g, "script"))), c.call(a[n], g, n);
            if (h)
                for (j = i[i.length - 1].ownerDocument, m.map(i, Ca), n = 0; h > n; n++) g = i[n], aa.test(g.type || "") && !m._data(g, "globalEval") && m.contains(j, g) && (g.src ? m._evalUrl && m._evalUrl(g.src) : m.globalEval((g.text || g.textContent || g.innerHTML || "").replace(xa, "")));
            l = f = null
        }
        return a
    }
    m.extend({
        htmlPrefilter: function(a) {
            return a.replace(ta, "<$1></$2>")
        },
        clone: function(a, b, c) {
            var d, e, f, g, h, i = m.contains(a.ownerDocument, a);
            if (k.html5Clone || m.isXMLDoc(a) || !sa.test("<" + a.nodeName + ">") ? f = a.cloneNode(!0) : (za.innerHTML = a.outerHTML, za.removeChild(f = za.firstChild)), !(k.noCloneEvent && k.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || m.isXMLDoc(a)))
                for (d = fa(f), h = fa(a), g = 0; null != (e = h[g]); ++g) d[g] && Ea(e, d[g]);
            if (b)
                if (c)
                    for (h = h || fa(a), d = d || fa(f), g = 0; null != (e = h[g]); g++) Da(e, d[g]);
                else Da(a, f);
        ...
        append: function() {
            return Fa(this, arguments, function(a) {
        ...
        before: function() {
            return Fa(this, arguments, function(a) { this.parentNode && this.parentNode.insertBefore(a, this) })
        },
        after: function() {
            return Fa(this, arguments, function(a) { this.parentNode && this.parentNode.insertBefore(a, this.nextSibling) })
        },
        remove: function(a, b) {
            for (var c, d = a ? m.filter(a, this) : this, e = 0; null != (c = d[e]); e++) b || 1 !== c.nodeType || m.cleanData(fa(c)), c.parentNode && (b && m.contains(c.ownerDocument, c) && ga(fa(c, "script")), c.parentNode.removeChild(c));
            return this
        },
        empty: function() {
        ...
        html: function(a) {
            return Z(this, function(a) {
                var b = this[0] || {},
                    c = 0,
                    d = this.length;
                if (void 0 === a) return 1 === b.nodeType ? b.innerHTML.replace(ra, "") : void 0;
                if (!("string" != typeof a || ua.test(a) || !k.htmlSerialize && sa.test(a) || !k.leadingWhitespace && ba.test(a) || ea[(_.exec(a) || ["", ""])[1].toLowerCase()])) {
                    a = m.htmlPrefilter(a);
                    try {
        ...
        replaceWith: function() {
            var a = [];
            return Fa(this, arguments, function(b) {
    ...
    ! function() {
        ...
        if (b = y.createElement("div"), b.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", e = b.getElementsByTagName("a")[0], d = e && e.style) {
            ...
            function l() {
                var d, e, k = y.body;
                k && k.style && (k.appendChild(c), b.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:absolute;display:block;margin:0;margin-top:1%;margin-right:50%;border:1px;padding:1px;top:1%;height:4px;width:50%", f = g = !1, h = j = !0, a.getComputedStyle && (e = a.getComputedStyle(b), f = "1%" !== (e || {}).top, g = "4px" === (e || { height: "4px" }).height, h = "4px" === (e || { marginRight: "4px" }).marginRight, d = b.appendChild(y.createElement("div")), d.style.cssText = b.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", d.style.marginRight = d.style.width = "0", b.style.width = "1px", j = !parseFloat((a.getComputedStyle(d) || {}).marginRight), b.removeChild(d)), b.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", d = b.getElementsByTagName("td"), d[0].style.cssText = "margin:0;border:0;padding:0;display:none", i = 0 === d[0].offsetHeight, i && (d[0].style.display = "", d[1].style.display = "none", i = 0 === d[0].offsetHeight), k.removeChild(c))
            }
        }
    }();
    var Ia, Ja, Ka = /^(top|right|bottom|left)$/;
    a.getComputedStyle ? (Ia = function(b) {
        return b.ownerDocument.defaultView.opener ? b.ownerDocument.defaultView.getComputedStyle(b) : a.getComputedStyle(b)
    }, Ja = function(a, b, c) {
        var d, e, f, g, h = a.style;
        return c = c || Ia(a), g = c ? c.getPropertyValue(b) || c[b] : void 0, c && ("" !== g || m.contains(a.ownerDocument, a) || (g = m.style(a, b)), !k.pixelMarginRight() && Ha.test(g) && Ga.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = g, g = c.width, h.width = d, h.minWidth = e, h.maxWidth = f)), void 0 === g ? g : g + ""
    }) : y.documentElement.currentStyle && (Ia = function(a) {
        return a.currentStyle
    }, Ja = function(a, b, c) {
        var d, e, f = a.style;
        return c = c || Ia(a), e = c ? c[b] : void 0, null == e && f && f[b] && (e = f[b]), Ha.test(e) && !Ka.test(b) && (d = f.left, f.left = "fontSize" === b ? "1em" : e, e = f.pixelLeft + "px", f.left = d), void 0 === e ? e : e + "" || "auto"
    });
    ...
    function Wa(a, b, c) {
        var d = !0,
            ...
            f = Ia(a),
            g = "border-box" === m.css(a, "boxSizing", !1, f);
        if (0 >= e || null == e) {
            if (e = Ja(a, b, f), (0 > e || null == e) && (e = a.style[b]), Ha.test(e)) return e;
            d = g && (k.boxSizingReliable() || e === a.style[b]), e = parseFloat(e) || 0
        }
        return e + Va(a, b, c || (g ? "border" : "content"), d, f) + "px"
    }
    m.extend({
        cssHooks: {
            opacity: {
        ...
        style: function(a, b, c, d) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                var e, f, g, h = m.camelCase(b),
                    i = a.style;
                if (b = m.cssProps[h] || (m.cssProps[h] = Ta(i, h)), g = m.cssHooks[b] || m.cssHooks[h], void 0 === c) return g && "get" in g && void 0 !== (e = g.get(a, !1, d)) ? e : i[b];
                if (f = typeof c, "string" === f && (e = T.exec(c)) && e[1] && (c = X(a, b, e), f = "number"), null != c && c === c && ("number" === f && (c += e && e[3] || (m.cssNumber[h] ? "" : "px")), k.clearCloneStyle || "" !== c || 0 !== b.indexOf("background") || (i[b] = "inherit"), !(g && "set" in g && void 0 === (c = g.set(a, c, d))))) try { i[b] = c } catch (j) {}
            }
        },
        css: function(a, b, c, d) {
            var e, f, g, h = m.camelCase(b);
            return b = m.cssProps[h] || (m.cssProps[h] = Ta(a.style, h)), g = m.cssHooks[b] || m.cssHooks[h], g && "get" in g && (f = g.get(a, !0, c)), void 0 === f && (f = Ja(a, b, d)), "normal" === f && b in Ra && (f = Ra[b]), "" === c || c ? (e = parseFloat(f), c === !0 || m.isNumeric(e) ? e || 0 : f) : f
        }
    }), m.each(["height", "width"], function(a, b) {
        m.cssHooks[b] = {
            get: function(a, c, d) {
                return c ? Oa.test(m.css(a, "display")) && 0 === a.offsetWidth ? W(a, Qa, function() {
                    return Wa(a, b, d)
                }) : Wa(a, b, d) : void 0
            },
            set: function(a, c, d) {
                var e = d && Ia(a);
                return Ua(a, c, d ? Va(a, b, d, "border-box" === m.css(a, "boxSizing", !1, e), e) : 0)
            }
        }
        ...
        return b ? W(a, { display: "inline-block" }, Ja, [a, "marginRight"]) : void 0
        ...
        }, Ga.test(a) || (m.cssHooks[a + b].set = Ua)
    }), m.fn.extend({
        css: function(a, b) {
        ...
        toggle: function(a) {
            return "boolean" == typeof a ? a ? this.show() : this.hide() : this.each(function() { V(this) ? m(this).show() : m(this).hide() })
        }
    });
    ...
    m.Tween = Xa, Xa.prototype = {
        constructor: Xa,
        init: function(a, b, c, d, e, f) { this.elem = a, this.prop = c, this.easing = e || m.easing._default, this.options = b, this.start = this.now = this.cur(), this.end = d, this.unit = f || (m.cssNumber[c] ? "" : "px") },
        cur: function() {
        ...
        run: function(a) {
            ...
            return this.options.duration ? this.pos = b = m.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) : this.pos = b = a, this.now = (this.end - this.start) * b + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), c && c.set ? c.set(this) : Xa.propHooks._default.set(this), this
        }
    ...
    }, Xa.propHooks.scrollTop = Xa.propHooks.scrollLeft = { set: function(a) { a.elem.nodeType && a.elem.parentNode && (a.elem[a.prop] = a.now) } }, m.easing = {
        linear: function(a) {
            return a
        },
        swing: function(a) {
        ...
        _default: "swing"
    }, m.fx = Xa.prototype.init, m.fx.step = {};
    ...
    function cb() { Za && (a.requestAnimationFrame(cb), m.fx.tick()) }

    function db() {
        return setTimeout(function() { Ya = void 0 }), Ya = m.now()
    }
    ...
    function gb(a, b, c) {
        var d, e, f, g, h, i, j, k, l = "width" in b || "height" in b,
            ...
            q = a.nodeType && V(a),
            r = m._data(a, "fxshow");
        c.queue || (g = m._queueHooks(a, "fx"), null == g.unqueued && (g.unqueued = 0, h = g.empty.fire, g.empty.fire = function() { g.unqueued || h() }), g.unqueued++, n.always(function() { n.always(function() { g.unqueued--, m.queue(a, "fx").length || g.empty.fire() }) }));
        for (d in b)
            if (e = b[d], $a.test(e)) {
        ...
        if (i = !m.isEmptyObject(b), i || !m.isEmptyObject(o)) {
            l && 1 === a.nodeType && (c.overflow = [p.overflow, p.overflowX, p.overflowY], j = r && r.display, null == j && (j = m._data(a, "display")), k = m.css(a, "display"), "none" === k && (k = j || W(a, { display: "" }, function() {
                return m.css(a, "display")
            })), ("inline" === k || "inline-block" === k && null != j) && "none" === m.css(a, "float") && (i || (n.done(function() { p.display = j }), null == j && (k = p.display, j = "none" === k ? "" : k)), p.display = "inline-block")), c.overflow && (p.overflow = "hidden", n.always(function() { p.overflow = c.overflow[0], p.overflowX = c.overflow[1], p.overflowY = c.overflow[2] })), i = !1;
            for (d in o) i || (r ? "hidden" in r && (q = r.hidden) : r = m._data(a, "fxshow", { display: j }), f && (r.hidden = !q), q && Y([a], !0), n.done(function() {
                q || Y([a]), m._removeData(a, "fxshow");
                for (d in o) m.style(a, d, o[d])
            })), i = fb(q ? r[d] : 0, d, n), d in r || (r[d] = i.start, q && (i.end = i.start, i.start = "width" === d || "height" === d ? 1 : 0))
        }
    }
    ...
    function ib(a, b, c) {
        var d, e, f = 0,
            ...
            i = function() {
                if (e) return !1;
                for (var b = Ya || db(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0, f = 1 - d, g = 0, i = j.tweens.length; i > g; g++) j.tweens[g].run(f);
            ...
            k = j.props;
        for (hb(k, j.opts.specialEasing); g > f; f++)
            if (d = ab[f].call(j, a, k, j.opts)) return d;
        return m.map(k, fb, j), m.isFunction(j.opts.start) && j.opts.start.call(a, j), m.fx.timer(m.extend(i, { elem: a, anim: j, queue: j.opts.queue })), j.progress(j.opts.progress).done(j.opts.done, j.opts.complete).fail(j.opts.fail).always(j.opts.always)
    }
    m.Animation = m.extend(ib, {
            tweener: function(a, b) {
                m.isFunction(a) ? (b = a, a = ["*"]) : a = a.split(" ");
                for (var c, d = 0, e = a.length; e > d; d++) c = a[d], bb[c] = bb[c] || [], bb[c].unshift(b)
            },
            prefilter: function(a, b) { b ? ab.unshift(a) : ab.push(a) }
        }), m.speed = function(a, b, c) {
            var d = a && "object" == typeof a ? m.extend({}, a) : { complete: c || !c && b || m.isFunction(a) && a, duration: a, easing: c && b || b && !m.isFunction(b) && b };
            return m.fx.off || y.hidden ? d.duration = 0 : d.duration = "number" == typeof d.duration ? d.duration : d.duration in m.fx.speeds ? m.fx.speeds[d.duration] : m.fx.speeds._default, (null == d.queue || d.queue === !0) && (d.queue = "fx"), d.old = d.complete, d.complete = function() { m.isFunction(d.old) && d.old.call(this), d.queue && m.dequeue(this, d.queue) }, d
        }, m.fn.extend({
            ...
            m.fn[b] = function(a, d, e) {
                return null == a || "boolean" == typeof a ? c.apply(this, arguments) : this.animate(eb(b, !0), a, d, e)
            }
        }), m.each({ slideDown: eb("show"), slideUp: eb("hide"), slideToggle: eb("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function(a, b) {
            ...
            var a, b = m.timers,
                c = 0;
            for (Ya = m.now(); c < b.length; c++) a = b[c], a() || b[c] !== a || b.splice(c--, 1);
            b.length || m.fx.stop(), Ya = void 0
        }, m.fx.timer = function(a) { m.timers.push(a), a() ? m.fx.start() : m.timers.pop() }, m.fx.interval = 13, m.fx.start = function() { Za = a.requestAnimationFrame ? a.requestAnimationFrame(cb) : setInterval(m.fx.tick, m.fx.interval) }, m.fx.stop = function() { a.cancelAnimationFrame ? a.cancelAnimationFrame(Za) : clearInterval(Za), Za = null }, m.fx.speeds = { slow: 600, fast: 200, _default: 400 }, m.fn.delay = function(a, b) {
    ...
    m.fn.extend({
        val: function(a) {
            var b, c, d, e = this[0]; {
                ...
                if (e) return b = m.valHooks[e.type] || m.valHooks[e.nodeName.toLowerCase()], b && "get" in b && void 0 !== (c = b.get(e, "value")) ? c : (c = e.value, "string" == typeof c ? c.replace(jb, "") : null == c ? "" : c)
            }
        }
    }), m.extend({
        valHooks: {
    ...
    m.fn.extend({
        ...
        attr: function(a, b, c) {
            var d, e, f = a.nodeType;
            if (3 !== f && 8 !== f && 2 !== f) return "undefined" == typeof a.getAttribute ? m.prop(a, b, c) : (1 === f && m.isXMLDoc(a) || (b = b.toLowerCase(), d = m.attrHooks[b] || (m.expr.match.bool.test(b) ? kb : void 0)), void 0 === c ? d && "get" in d && null !== (e = d.get(a, b)) ? e : (e = m.find.attr(a, b), null == e ? void 0 : e) : null !== c ? d && "set" in d && void 0 !== (e = d.set(a, c, b)) ? e : (a.setAttribute(b, c + ""), c) : void m.removeAttr(a, b))
        },
        removeAttr: function(a, b) {
            var c, d, e = 0,
                f = b && b.match(E);
            if (f && 1 === a.nodeType)
                while (c = f[e++]) d = m.propFix[c] || c, m.expr.match.bool.test(c) && (nb || !mb.test(c) ? a[d] = !1 : a[m.camelCase("default-" + c)] = a[d] = !1), a.removeAttribute(c)
        },
        attrHooks: {
            type: {
                set: function(a, b) {
        ...
        set: function(a, b, c) {
            return b === !1 ? m.removeAttr(a, c) : nb || !mb.test(c) ? a.setAttribute(m.propFix[c] || c, c) : a[m.camelCase("default-" + c)] = a[c] = !0, c
        }
    }, m.each(m.expr.match.bool.source.match(/\w+/g), function(a, b) {
        var c = lb[b] || m.find.attr;
        lb[b] = nb || !mb.test(b) ? function(a, b, d) {
            var e, f;
            return d || (f = lb[b], lb[b] = e, e = null != c(a, b, d) ? b.toLowerCase() : null, lb[b] = f), e
        } : function(a, b, c) {
            return c ? void 0 : a[m.camelCase("default-" + b)] ? b.toLowerCase() : null
        }
    }), nb || (m.attrHooks.value = { set: function(a, b) { m.nodeName(a, "input") && (a.defaultValue = b) } }), k.style || (m.attrHooks.style = {
        get: function(a) {
    ...
    var ob = /^(?:input|select|textarea|button|object)$/i,
        pb = /^(?:a|area)$/i;
    m.fn.extend({
        prop: function(a, b) {
        ...
        propHooks: {
            tabIndex: {
                get: function(a) {
                    ...
                    return b ? parseInt(b, 10) : ob.test(a.nodeName) || pb.test(a.nodeName) && a.href ? 0 : -1
                }
            }
        }
    ...
    m.fn.extend({
        addClass: function(a) {
            var b, c, d, e, f, g, h, i = 0,
                j = this.length,
                k = "string" == typeof a && a;
            if (m.isFunction(a)) return this.each(function(b) { m(this).addClass(a.call(this, b, rb(this))) });
            if (k)
                for (b = (a || "").match(E) || []; j > i; i++)
                    if (c = this[i], e = rb(c), d = 1 === c.nodeType && (" " + e + " ").replace(qb, " ")) {
                        g = 0;
        ...
        removeClass: function(a) {
            ...
            if (m.isFunction(a)) return this.each(function(b) { m(this).removeClass(a.call(this, b, rb(this))) });
            if (k)
                for (b = (a || "").match(E) || []; j > i; i++)
                    if (c = this[i], e = rb(c), d = 1 === c.nodeType && (" " + e + " ").replace(qb, " ")) {
                        g = 0;
        ...
        toggleClass: function(a, b) {
            var c = typeof a;
            return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : this.each(m.isFunction(a) ? function(c) { m(this).toggleClass(a.call(this, c, rb(this), b), b) } : function() {
                var b, d, e, f;
                if ("string" === c) {
                    d = 0, e = m(this), f = a.match(E) || [];
                    while (b = f[d++]) e.hasClass(b) ? e.removeClass(b) : e.addClass(b)
                } else(void 0 === a || "boolean" === c) && (b = rb(this), b && m._data(this, "__className__", b), this.setAttribute && this.setAttribute("class", b || a === !1 ? "" : m._data(this, "__className__") || ""))
            })
        },
        hasClass: function(a) {
            for (var b = " " + a + " ", c = 0, d = this.length; d > c; c++)
                if (1 === this[c].nodeType && (" " + rb(this[c]) + " ").replace(qb, " ").indexOf(b) > -1) return !0;
            return !1
        }
    ...
    m.extend({
        ...
        lastModified: {},
        etag: {},
        ajaxSettings: { url: location.href, type: "GET", isLocal: xb.test(location.protocol), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: { "*": Cb, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript" }, contents: { xml: /xml/, html: /html/, json: /json/ }, responseFields: { xml: "responseXML", text: "responseText", json: "responseJSON" }, converters: { "* text": String, "text html": !0, "text json": m.parseJSON, "text xml": m.parseXML }, flatOptions: { url: !0, context: !0 } },
        ajaxSetup: function(a, b) {
            return b ? Gb(Gb(a, m.ajaxSettings), b) : Gb(m.ajaxSettings, a)
        },
        ajaxPrefilter: Eb(Ab),
        ajaxTransport: Eb(Bb),
        ajax: function(a, b) {
                ...
                v = {
                    ...
                    getResponseHeader: function(a) {
                        ...
                        if (2 === t) {
                            if (!j) {
                                j = {};
                                while (b = wb.exec(e)) j[b[1].toLowerCase()] = b[2]
                            }
                            b = j[a.toLowerCase()]
                        }
            ...
            if (o.promise(v), k.url = ((a || k.url || location.href) + "").replace(ub, "").replace(zb, location.protocol + "//"), k.type = b.method || b.type || k.method || k.type, k.dataTypes = m.trim(k.dataType || "*").toLowerCase().match(E) || [""], null == k.crossDomain) {
                g = y.createElement("a");
                try { g.href = k.url, g.href = g.href, k.crossDomain = Db.protocol + "//" + Db.host != g.protocol + "//" + g.host } catch (w) { k.crossDomain = !0 }
            }
            if (k.data && k.processData && "string" != typeof k.data && (k.data = m.param(k.data, k.traditional)), Fb(Ab, k, b, v), 2 === t) return v;
            h = m.event && k.global, h && 0 === m.active++ && m.event.trigger("ajaxStart"), k.type = k.type.toUpperCase(), k.hasContent = !yb.test(k.type), d = k.url, k.hasContent || (k.data && (d = k.url += (tb.test(d) ? "&" : "?") + k.data, delete k.data), k.cache === !1 && (k.url = vb.test(d) ? d.replace(vb, "$1_=" + sb++) : d + (tb.test(d) ? "&" : "?") + "_=" + sb++)), k.ifModified && (m.lastModified[d] && v.setRequestHeader("If-Modified-Since", m.lastModified[d]), m.etag[d] && v.setRequestHeader("If-None-Match", m.etag[d])), (k.data && k.hasContent && k.contentType !== !1 || b.contentType) && v.setRequestHeader("Content-Type", k.contentType), v.setRequestHeader("Accept", k.dataTypes[0] && k.accepts[k.dataTypes[0]] ? k.accepts[k.dataTypes[0]] + ("*" !== k.dataTypes[0] ? ", " + Cb + "; q=0.01" : "") : k.accepts["*"]);
            for (c in k.headers) v.setRequestHeader(c, k.headers[c]);
            if (k.beforeSend && (k.beforeSend.call(l, v, k) === !1 || 2 === t)) return v.abort();
            if (u = "abort", p.add(k.complete), v.done(k.success), v.fail(k.error), i = Fb(Bb, k, b, v)) {
                if (v.readyState = 1, h && n.trigger("ajaxSend", [v, k]), 2 === t) return v;
                k.async && k.timeout > 0 && (f = setTimeout(function() { v.abort("timeout") }, k.timeout));
            ...
            function x(a, b, c, g) {
                var j, r, s, u, w, x = b;
                2 !== t && (t = 2, f && clearTimeout(f), i = void 0, e = g || "", v.readyState = a > 0 ? 4 : 0, j = a >= 200 && 300 > a || 304 === a, c && (u = Hb(k, v, c)), u = Ib(k, u, v, j), j ? (k.ifModified && (w = v.getResponseHeader("Last-Modified"), w && (m.lastModified[d] = w), w = v.getResponseHeader("etag"), w && (m.etag[d] = w)), 204 === a || "HEAD" === k.type ? x = "nocontent" : 304 === a ? x = "notmodified" : (x = u.state, r = u.data, s = u.error, j = !s)) : (s = x, (a || !x) && (x = "error", 0 > a && (a = 0))), v.status = a, v.statusText = (b || x) + "", j ? o.resolveWith(l, [r, x, v]) : o.rejectWith(l, [v, x, s]), v.statusCode(q), q = void 0, h && n.trigger(j ? "ajaxSuccess" : "ajaxError", [v, k, j ? r : s]), p.fireWith(l, [v, x]), h && (n.trigger("ajaxComplete", [v, k]), --m.active || m.event.trigger("ajaxStop")))
            }
            return v
        },
        ...
        unwrap: function(a) {
            return this.parent(a).not("body").each(function() { m(this).replaceWith(this.childNodes) }), this
        }
    ...
    function Ob(a, b, c, d) {
        var e;
        if (m.isArray(b)) m.each(b, function(b, e) { c || Kb.test(a) ? d(a, e) : Ob(a + "[" + ("object" == typeof e ? b : "") + "]", e, c, d) });
    ...
    m.param = function(a, b) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var a = this.type;
                return this.name && !m(this).is(":disabled") && Nb.test(this.nodeName) && !Mb.test(a) && (this.checked || !$.test(a))
            }).map(function(a, b) {
                var c = m(this).val();
        ...
        return !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && Qb() || Rb()
    } : Qb;
    var Pb = m.ajaxSettings.xhr();
    k.cors = !!Pb && "withCredentials" in Pb, Pb = k.ajax = !!Pb, Pb && m.ajaxTransport(function(a) {
    ...
    m.ajaxSetup({
        ...
        return h || "jsonp" === b.dataTypes[0] ? (e = b.jsonpCallback = m.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, h ? b[h] = b[h].replace(Tb, "$1" + e) : b.jsonp !== !1 && (b.url += (tb.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), b.converters["script json"] = function() {
            return g || m.error(e + " was not called"), g[0]
        }, b.dataTypes[0] = "json", f = a[e], a[e] = function() { g = arguments }, d.always(function() { a[e] = f, b[e] && (b.jsonpCallback = c.jsonpCallback, Sb.push(e)), g && m.isFunction(f) && f(g[0]), g = f = void 0 }), "script") : void 0
    ...
    m.fn.load = function(a, b, c) {
        ...
        var d, e, f, g = this,
            h = a.indexOf(" ");
        return h > -1 && (d = m.trim(a.slice(h, a.length)), a = a.slice(0, h)), m.isFunction(b) ? (c = b, b = void 0) : b && "object" == typeof b && (f = "POST"), g.length > 0 && m.ajax({ url: a, type: f || "GET", dataType: "html", data: b }).done(function(a) { e = arguments, g.html(d ? m("<div>").append(m.parseHTML(a)).find(d) : a) }).always(c && function(a, b) { g.each(function() { c.apply(g, e || [a.responseText, b, a]) }) }), this
    ...
    m.offset = {
        ...
        offset: function(a) {
            ...
            if (f) return d = f.getBoundingClientRect(), d.width || d.height || f.getClientRects().length ? (e = f.ownerDocument, c = Wb(e), b = e.documentElement, { top: d.top + (c.pageYOffset || b.scrollTop) - (b.clientTop || 0), left: d.left + (c.pageXOffset || b.scrollLeft) - (b.clientLeft || 0) }) : void 0
        },
        position: function() {
            if (this[0]) {
                var a, b, c = { top: 0, left: 0 },
                    d = this[0];
                return "fixed" === m.css(d, "position") ? b = d.getBoundingClientRect() : (a = this.offsetParent(), b = this.offset(), m.nodeName(a[0], "html") || (c = a.offset()), c.top += m.css(a[0], "borderTopWidth", !0) - a.scrollTop(), c.left += m.css(a[0], "borderLeftWidth", !0) - a.scrollLeft()), { top: b.top - c.top - m.css(d, "marginTop", !0), left: b.left - c.left - m.css(d, "marginLeft", !0) }
            }
        },
    ...
    return m.noConflict = function(b) {
        return a.$ === m && (a.$ = Yb), b && a.jQuery === m && (a.jQuery = Xb), m
    }, b || (a.jQuery = a.$ = m), m
});
